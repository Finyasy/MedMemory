...
class Document(Base, TimestampMixin):
    ...
    file_hash: Mapped[str | None] = mapped_column(
        String(64), nullable=True, unique=True, comment="SHA-256 hash for deduplication"
    )
    ...
    ocr_text_cleaned: Mapped[str | None] = mapped_column(Text, nullable=True)
    ocr_entities: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
