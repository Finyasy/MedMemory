...
class EncounterIngestionService(IngestionService[Encounter]):
    ...
    async def ingest_single(self, data: dict) -> Encounter:
        ...
        encounter = Encounter(
            ...
            # Vitals
            vital_blood_pressure=vitals.get("blood_pressure")
            or data.get("vital_blood_pressure"),
            vital_heart_rate=self._parse_int(
                vitals.get("heart_rate") or data.get("vital_heart_rate")
            ),
            vital_temperature=self.parse_float(
                vitals.get("temperature") or data.get("vital_temperature")
            ),
            vital_weight=self.parse_float(
                vitals.get("weight") or data.get("vital_weight")
            ),
            vital_height=self.parse_float(
                vitals.get("height") or data.get("vital_height")
            ),
            vital_bmi=self.parse_float(vitals.get("bmi") or data.get("vital_bmi")),
            vital_oxygen_saturation=self.parse_float(
                vitals.get("oxygen_saturation") or data.get("vital_oxygen_saturation")
            ),
    ...
    def _build_clinical_notes(self, data: dict) -> str | None:
